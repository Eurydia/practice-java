...
@Suite
@SelectClasses({
        BookStructureTest.class, BookTest.class, InvalidBookExceptionStructureTest.class

        , EBookStructureTest.class, CoverTypeStructureTest.class, PrintedBookStructureTest.class

        , DamagedBookStructureTest.class, BookCollectionStructureTest.class
})
